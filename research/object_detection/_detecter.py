...
# PATH_TO_CKPT = '/home/sangsuper/git/models/research/0502_from_mix_566678/output_inference_graph.pb/frozen_inference_graph.pb'
PATH_TO_CKPT = 'checkpoints/excavator_2018-07-30/frozen_inference_graph.pb'
# PATH_TO_CKPT = '/home/sangsuper/git/models/research/object_detection/models/model/train/graph.pbtxt'
# List of the strings that is used to add correct label for each box.
# PATH_TO_LABELS = os.path.join('data', 'skn_label_map.pbtxt')
...
PATH_TO_TEST_IMAGES_DIR = '/home/ace19/dl_data/excavator2/tmp'
